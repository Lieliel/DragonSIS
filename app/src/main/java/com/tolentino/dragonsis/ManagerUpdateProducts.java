...
public class ManagerUpdateProducts extends AppCompatActivity {
    ...
    EditText edit_upd_prod_total_quantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_upd_prod_total_quantity = findViewById(R.id.edit_upd_prod_total_quantity);
        ...
        Log.i("Product Shared Pref", pref.getString("prod_id", null) + ", " + pref.getString("prod_name", null) + ", " + pref.getString("prod_total_quantity", null) + ", " + pref.getString("prod_critical_num", null) + ", " + pref.getString("prod_price", null) + ", " + pref.getString("prod_category", null));
        ...
        edit_upd_prod_total_quantity.setText(pref.getString("prod_total_quantity", null));
        ...
        btn_upd_prod_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String prod_total_quantity = edit_upd_prod_total_quantity.getText().toString();
